...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "Le modèle de l'offre et de la demande constitue la pierre angulaire de l'analyse économique. Formulé par Alfred Marshall dans ses Principes d'économie politique (1890), il décrit comment le prix d'un bien se forme spontanément par la rencontre entre acheteurs et vendeurs sur un marché concurrentiel. Adam Smith avait déjà pressenti ce mécanisme en parlant de « main invisible » : sans coordination centrale, les agents économiques, guidés par leur intérêt personnel, parviennent à un équilibre qui détermine à la fois le prix et la quantité échangée.\n\nLa courbe de demande traduit le comportement des consommateurs : plus le prix augmente, moins ils souhaitent acheter (loi de la demande). Inversement, la courbe d'offre reflète le comportement des producteurs : plus le prix est élevé, plus ils sont incités à produire et à vendre. Le point d'intersection de ces deux courbes définit l'équilibre de marché, où la quantité offerte correspond exactement à la quantité demandée. Tout déséquilibre (excès d'offre ou de demande) déclenche un ajustement des prix qui ramène le marché vers l'équilibre.\n\nAu-delà de l'équilibre, ce modèle permet d'analyser les effets de politiques publiques comme les taxes ou les prix plafonds. Une taxe, par exemple, crée un écart entre le prix payé par le consommateur et celui reçu par le producteur, réduisant les quantités échangées et générant une perte sèche pour la collectivité. Le partage de la charge fiscale dépend des élasticités respectives de l'offre et de la demande, un résultat contre-intuitif mais fondamental en économie publique.",
    keyConcepts: [
      { term: "Loi de la demande", definition: "Toutes choses égales par ailleurs, lorsque le prix d'un bien augmente, la quantité demandée diminue. Cette relation inverse s'explique par l'effet de substitution (les consommateurs se tournent vers des biens moins chers) et l'effet de revenu (le pouvoir d'achat diminue)." },
      { term: "Loi de l'offre", definition: "Toutes choses égales par ailleurs, lorsque le prix d'un bien augmente, la quantité offerte augmente. Les producteurs sont incités à produire davantage quand le prix de vente est plus élevé, car cela couvre des coûts marginaux plus importants." },
      { term: "Équilibre de marché", definition: "Situation où la quantité offerte est exactement égale à la quantité demandée. Le prix d'équilibre est le seul prix pour lequel il n'existe ni excès d'offre ni excès de demande. Toute déviation déclenche des forces de rappel." },
      { term: "Surplus du consommateur", definition: "Différence entre le prix maximal qu'un consommateur est prêt à payer et le prix d'équilibre qu'il paye effectivement. Graphiquement, c'est l'aire du triangle entre la courbe de demande et la droite du prix d'équilibre." },
      { term: "Perte sèche", definition: "Perte de bien-être collectif causée par une distorsion de marché (taxe, prix plafond). Elle correspond aux échanges mutuellement bénéfiques qui n'ont plus lieu à cause de l'intervention. Elle est représentée par le triangle de Harberger." },
    ],
    methodology: "Commencez par observer l'équilibre initial : notez le prix et la quantité d'équilibre. Augmentez ensuite le revenu des consommateurs et observez le déplacement de la courbe de demande vers la droite. Comment le prix et la quantité d'équilibre changent-ils ? Faites la même expérience avec le coût de production pour observer un déplacement de l'offre. Enfin, introduisez une taxe et repérez la perte sèche qui apparaît. Comparez la taille de cette perte selon les différentes élasticités.",
    forTeachers: "Projetez le module en mode plein écran. Demandez aux élèves de prédire l'effet d'une hausse des coûts de production avant de bouger le curseur. Utilisez le scénario « choc pétrolier » pour illustrer un choc d'offre, puis demandez-leur d'identifier graphiquement le surplus du consommateur et la perte sèche.",
  },
};
