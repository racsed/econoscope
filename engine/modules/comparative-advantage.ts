...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "La théorie des avantages comparatifs, formulée par David Ricardo dans ses Principes de l'économie politique et de l'impôt (1817), est l'un des résultats les plus importants et les plus contre-intuitifs de la science économique. Elle démontre que le commerce international est mutuellement bénéfique même si un pays est plus productif que l'autre dans tous les domaines. Ce qui compte n'est pas la productivité absolue, mais le coût d'opportunité relatif : chaque pays a intérêt à se spécialiser dans le bien pour lequel il est « relativement le moins mauvais » (ou « relativement le meilleur »).\n\nPrenons un exemple concret. Supposons que la France produise à la fois du vin et du tissu plus efficacement que le Portugal. Mais si la France est 3 fois plus productive en vin et seulement 1,5 fois plus productive en tissu, alors la France a un avantage comparatif dans le vin et le Portugal dans le tissu. En se spécialisant, les deux pays produisent davantage au total qu'en autarcie. Le commerce permet ensuite d'échanger les surplus, si bien que chaque pays consomme davantage des deux biens. C'est un jeu à somme positive, contrairement à l'idée mercantiliste selon laquelle le commerce est un jeu à somme nulle.\n\nCette théorie reste le fondement intellectuel du libre-échange et de la mondialisation. Toutefois, elle repose sur des hypothèses fortes que les économistes modernes ont nuancées. Paul Samuelson a montré que le commerce peut réduire les revenus de certains facteurs de production (théorème Stolper-Samuelson). Les industries naissantes peuvent avoir besoin de protection temporaire (argument de Friedrich List). Les coûts de transition pour les travailleurs déplacés sont réels et douloureux. Le débat contemporain ne porte donc plus sur le principe de l'avantage comparatif (quasi unanimement accepté) mais sur les politiques d'accompagnement nécessaires pour en partager les bénéfices.",
    keyConcepts: [
      { term: "Avantage absolu (Adam Smith)", definition: "Un pays possède un avantage absolu dans la production d'un bien s'il peut le produire avec moins de ressources que l'autre pays. Smith pensait que le commerce n'était bénéfique qu'entre pays ayant chacun un avantage absolu. Ricardo a montré que cette condition n'était pas nécessaire." },
      { term: "Avantage comparatif (Ricardo)", definition: "Un pays possède un avantage comparatif dans la production d'un bien si son coût d'opportunité de production est inférieur à celui de l'autre pays. Même un pays moins productif partout possède un avantage comparatif dans au moins un bien. C'est le coût relatif, non absolu, qui détermine la spécialisation." },
      { term: "Coût d'opportunité de production", definition: "Quantité d'un bien B qu'un pays doit sacrifier pour produire une unité supplémentaire du bien A. C'est la clé de la détermination de l'avantage comparatif. Le pays dont le coût d'opportunité est le plus faible pour le bien A a l'avantage comparatif dans ce bien." },
      { term: "Gains de l'échange", definition: "Augmentation de la consommation totale rendue possible par la spécialisation et le commerce. Les deux pays consomment au-delà de leur frontière des possibilités de production grâce à l'échange. Ces gains proviennent de la meilleure allocation des ressources mondiales." },
      { term: "Termes de l'échange", definition: "Prix relatif auquel les biens s'échangent entre les deux pays. Les termes de l'échange doivent se situer entre les coûts d'opportunité des deux pays pour que le commerce soit mutuellement bénéfique. Leur position exacte détermine le partage des gains entre les partenaires." },
    ],
    methodology: "Commencez par observer les productivités des deux pays dans les deux biens. Calculez les coûts d'opportunité pour identifier qui a l'avantage comparatif dans quel bien. Activez la spécialisation et le commerce, puis comparez les quantités consommées avec et sans échange. Modifiez les productivités pour créer un cas où un pays est meilleur partout : constatez que le commerce reste bénéfique. Essayez le cas extrême où les productivités relatives sont identiques (pas d'avantage comparatif).",
    forTeachers: "L'exemple classique vin/tissu France/Portugal est parlant. Demandez aux élèves de calculer les coûts d'opportunité avant d'utiliser le simulateur. Le passage de l'avantage absolu (Smith) à l'avantage comparatif (Ricardo) est un moment conceptuel clé. Reliez à l'actualité : les débats sur le protectionnisme et les relocalisations post-Covid.",
  },
};
