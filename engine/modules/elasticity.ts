...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "L'élasticité-prix de la demande est un concept central introduit par Alfred Marshall pour mesurer la sensibilité des consommateurs aux variations de prix. En termes formels, elle correspond au rapport entre la variation en pourcentage de la quantité demandée et la variation en pourcentage du prix. Si une hausse de prix de 10 % entraîne une baisse de la demande de 20 %, l'élasticité vaut -2 : la demande est dite « élastique ». Ce coefficient permet de comprendre pourquoi certains biens résistent aux hausses de prix tandis que d'autres voient leur demande s'effondrer.\n\nLa valeur de l'élasticité dépend de plusieurs facteurs. Les biens de première nécessité (pain, essence, médicaments) ont une demande inélastique : les consommateurs continuent de les acheter même si le prix augmente, car ils n'ont pas de bons substituts. A l'inverse, les biens de luxe ou les biens facilement substituables (une marque de céréales parmi d'autres) ont une demande très élastique. L'horizon temporel joue aussi : à court terme, la demande est souvent plus rigide qu'à long terme, car les consommateurs ont besoin de temps pour adapter leurs habitudes.\n\nL'élasticité est un outil stratégique aussi bien pour les entreprises que pour les pouvoirs publics. Une entreprise vendant un bien inélastique peut augmenter ses prix sans perdre beaucoup de clients, ce qui augmente sa recette totale. Un gouvernement qui veut réduire la consommation de tabac sait que la taxation sera modérément efficace à court terme (élasticité d'environ -0,4), mais plus efficace à long terme. La relation entre élasticité et recette totale est fondamentale : lorsque la demande est élastique, baisser le prix augmente la recette ; lorsqu'elle est inélastique, c'est l'inverse.",
    keyConcepts: [
      { term: "Élasticité-prix de la demande", definition: "Rapport entre la variation relative de la quantité demandée et la variation relative du prix. Formule : Ep = (%ΔQ) / (%ΔP). Elle est généralement négative (loi de la demande). On utilise souvent sa valeur absolue pour classer la sensibilité." },
      { term: "Demande élastique (|Ep| > 1)", definition: "La quantité demandée varie proportionnellement plus que le prix. Une hausse de prix provoque une baisse plus que proportionnelle de la demande. C'est typique des biens de luxe ou des biens avec beaucoup de substituts." },
      { term: "Demande inélastique (|Ep| < 1)", definition: "La quantité demandée varie proportionnellement moins que le prix. Les consommateurs absorbent la hausse de prix sans réduire significativement leur consommation. C'est le cas des biens essentiels comme l'eau, l'énergie ou les médicaments." },
      { term: "Recette totale", definition: "Produit du prix par la quantité vendue (RT = P x Q). Si la demande est élastique, une baisse de prix augmente la recette totale car le gain en quantité compense la baisse de prix. Si elle est inélastique, c'est l'inverse." },
      { term: "Élasticité unitaire (|Ep| = 1)", definition: "Cas particulier où la variation de la quantité compense exactement la variation du prix. La recette totale reste constante quel que soit le prix. Ce point correspond au maximum de la recette totale sur la courbe de demande." },
    ],
    methodology: "Commencez avec une élasticité de -1,0 et observez la courbe de demande. Augmentez le prix progressivement et notez comment la recette totale évolue. Passez ensuite à une demande très élastique (-2,5) puis très inélastique (-0,3) et refaites l'exercice. Observez comment la forme de la courbe de recette totale change. Repérez le prix qui maximise la recette dans chaque cas. Utilisez les scénarios prédéfinis pour comparer des situations réelles (essence vs restauration).",
    forTeachers: "Demandez aux élèves de classer des biens du quotidien par élasticité avant d'utiliser le simulateur. Projetez ensuite les courbes et vérifiez les intuitions. L'exercice « si vous étiez un chef d'entreprise, augmenteriez-vous le prix ? » permet de relier élasticité et stratégie commerciale.",
  },
};
