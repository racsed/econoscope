...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "Le modèle IS-LM, formalisé par John Hicks en 1937 à partir de la Théorie générale de Keynes, est le cadre de référence pour analyser l'équilibre macroéconomique simultané sur deux marchés : le marché des biens et services (courbe IS) et le marché de la monnaie (courbe LM). La courbe IS (Investment-Savings) représente l'ensemble des combinaisons de revenu national (Y) et de taux d'intérêt (r) pour lesquelles le marché des biens est en équilibre. La courbe LM (Liquidity preference-Money supply) représente les mêmes combinaisons pour l'équilibre monétaire. L'intersection détermine le niveau du revenu et du taux d'intérêt d'équilibre.\n\nLa force du modèle réside dans sa capacité à comparer les effets des politiques budgétaire et monétaire. Une hausse des dépenses publiques déplace IS vers la droite, augmentant le revenu mais aussi le taux d'intérêt. Cette hausse du taux d'intérêt décourage une partie de l'investissement privé : c'est l'effet d'éviction, qui atténue l'efficacité de la relance budgétaire. A l'inverse, une politique monétaire expansionniste déplace LM vers la droite, baissant le taux d'intérêt et stimulant l'investissement, sans effet d'éviction. L'efficacité relative des deux politiques dépend des pentes des courbes IS et LM.\n\nDeux cas extrêmes méritent attention. La trappe à liquidité survient quand le taux d'intérêt est si bas que LM devient horizontale : la politique monétaire est impuissante car les agents préfèrent détenir de la monnaie plutôt que des obligations, quel que soit le volume de monnaie injectée. Seule la politique budgétaire reste efficace. A l'opposé, le cas classique (LM verticale) rend la politique budgétaire totalement inefficace à cause de l'effet d'éviction total, tandis que la politique monétaire est pleinement efficace. Ce modèle, bien que simplifié, reste un outil pédagogique irremplaçable pour comprendre les grands choix de politique économique.",
    keyConcepts: [
      { term: "Courbe IS", definition: "Lieu des combinaisons (Y, r) assurant l'équilibre sur le marché des biens et services. Elle est décroissante : un taux d'intérêt plus bas stimule l'investissement, ce qui augmente la demande et le revenu d'équilibre. Sa position dépend des dépenses publiques, de la fiscalité et de la confiance des consommateurs." },
      { term: "Courbe LM", definition: "Lieu des combinaisons (Y, r) assurant l'équilibre sur le marché monétaire. Elle est croissante : un revenu plus élevé accroît la demande de monnaie pour les transactions, ce qui fait monter le taux d'intérêt pour rétablir l'équilibre. Sa position dépend de l'offre de monnaie fixée par la banque centrale." },
      { term: "Effet d'éviction", definition: "Mécanisme par lequel une hausse des dépenses publiques augmente le taux d'intérêt, décourageant l'investissement privé. L'effet d'éviction est total quand LM est verticale (cas classique) et nul quand LM est horizontale (trappe à liquidité)." },
      { term: "Trappe à liquidité", definition: "Situation où le taux d'intérêt est si proche de zéro que la courbe LM est horizontale. Toute injection de monnaie supplémentaire est absorbée par la préférence pour la liquidité sans faire baisser davantage le taux. La politique monétaire perd son efficacité. Le Japon des années 1990 et la zone euro post-2015 illustrent cette situation." },
      { term: "Policy mix", definition: "Combinaison de politique budgétaire et de politique monétaire visant un objectif macroéconomique. Un policy mix expansionniste combine hausse des dépenses publiques (IS vers la droite) et baisse des taux (LM vers la droite) pour maximiser l'effet sur le revenu tout en limitant la hausse des taux d'intérêt." },
    ],
    methodology: "Partez de l'équilibre initial et notez les valeurs de Y et r. Augmentez les dépenses publiques (G) et observez le déplacement de IS : le revenu augmente, mais le taux d'intérêt aussi. Calculez mentalement la part de la hausse de Y « perdue » par l'effet d'éviction. Revenez à l'équilibre initial, puis augmentez l'offre de monnaie : LM se déplace, r baisse, Y augmente sans éviction. Essayez enfin le scénario « trappe à liquidité » et constatez l'impuissance de la politique monétaire.",
    forTeachers: "Dessinez d'abord le modèle au tableau avec les élèves avant d'utiliser le simulateur. Posez la question : « Si vous êtes ministre des Finances en récession, quelle politique choisissez-vous ? ». Utilisez les deux scénarios extrêmes (trappe à liquidité vs cas classique) pour structurer le débat keynésiens/monétaristes.",
  },
};
