...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "La mesure des inégalités de revenus est un enjeu central en économie et en politique. Comment comparer la répartition des richesses entre pays ou à travers le temps ? Max Lorenz (1905) et Corrado Gini (1912) ont développé deux outils complémentaires qui restent les références mondiales : la courbe de Lorenz et le coefficient de Gini. Ces instruments permettent de passer d'une perception vague des inégalités (« les riches sont très riches ») à une mesure précise et comparable.\n\nLa courbe de Lorenz représente graphiquement la répartition des revenus. Sur l'axe horizontal, on place la population cumulée (des plus pauvres aux plus riches) ; sur l'axe vertical, la part cumulée du revenu total. Si les revenus étaient parfaitement égaux, la courbe serait une droite à 45° (diagonale d'égalité parfaite) : les 20 % les plus pauvres détiendraient exactement 20 % du revenu. En réalité, la courbe se situe en dessous de cette diagonale, formant un « ventre » d'autant plus prononcé que les inégalités sont fortes. Le coefficient de Gini mesure l'aire entre la courbe de Lorenz et la diagonale : il vaut 0 en cas d'égalité parfaite et 1 si un seul individu détient la totalité du revenu.\n\nThomas Piketty a renouvelé l'intérêt pour ces outils en montrant, dans Le Capital au XXIe siècle (2013), que les inégalités de patrimoine sont bien plus prononcées que les inégalités de revenus, et qu'elles tendent à s'accroître quand le taux de rendement du capital dépasse le taux de croissance (r > g). La France, grâce à un système de redistribution développé (impôt progressif, prestations sociales), passe d'un Gini d'environ 0,52 avant redistribution à 0,29 après, l'un des plus bas de l'OCDE. Comparer les Gini avant et après redistribution permet de mesurer l'efficacité du système fiscal et social d'un pays.",
    keyConcepts: [
      { term: "Courbe de Lorenz", definition: "Représentation graphique de la distribution cumulée des revenus. L'axe horizontal représente la part cumulée de la population (du plus pauvre au plus riche), l'axe vertical la part cumulée du revenu total. Plus la courbe s'éloigne de la diagonale d'égalité, plus les inégalités sont prononcées." },
      { term: "Coefficient de Gini", definition: "Indicateur synthétique d'inégalité compris entre 0 (égalité parfaite) et 1 (inégalité maximale). Il correspond au rapport entre l'aire située entre la diagonale et la courbe de Lorenz, et l'aire totale sous la diagonale. Un Gini de 0,30 est considéré comme modéré, au-delà de 0,45 les inégalités sont fortes." },
      { term: "Déciles de revenus", definition: "Division de la population en 10 groupes de taille égale, classés par niveau de revenu croissant. Le premier décile (D1) rassemble les 10 % les plus pauvres, le dernier (D10) les 10 % les plus riches. Le rapport interdécile D9/D1 est un indicateur simple d'inégalité souvent utilisé." },
      { term: "Redistribution", definition: "Ensemble des mécanismes par lesquels l'État modifie la répartition primaire des revenus (celle issue du marché). Elle passe par les prélèvements (impôts progressifs, cotisations) et les transferts (allocations, minima sociaux, services publics). En France, elle réduit le Gini d'environ 0,23 point." },
      { term: "Inégalités de patrimoine vs de revenus", definition: "Les inégalités de patrimoine (épargne, immobilier, actifs financiers) sont toujours plus prononcées que celles de revenus. En France, les 10 % les plus riches détiennent environ 25 % des revenus mais près de 50 % du patrimoine. Piketty montre que cet écart tend à s'accroître dans le temps." },
    ],
    methodology: "Commencez par sélectionner la distribution « Égalité parfaite » et observez la courbe de Lorenz alignée sur la diagonale (Gini = 0). Passez ensuite à « France » et notez l'écart avec la diagonale. Comparez avec les États-Unis et le Brésil. En mode personnalisé, modifiez la part de revenu détenue par chaque décile et observez l'impact sur le coefficient de Gini. Essayez de réduire le Gini en augmentant les transferts vers les déciles les plus bas.",
    forTeachers: "Faites calculer le Gini à la main sur un exemple simple (5 individus avec des revenus différents) avant d'utiliser le simulateur. La comparaison France/Brésil est très visuelle. Posez la question : « La France est-elle un pays égalitaire ? » et montrez l'écart entre le Gini avant et après redistribution pour nuancer la réponse.",
  },
};
