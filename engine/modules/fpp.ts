...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "La frontière des possibilités de production (FPP) est l'un des premiers modèles enseignés en économie car il illustre trois concepts fondamentaux : la rareté, le coût d'opportunité et l'efficacité. Ce modèle, utilisé depuis Paul Samuelson, représente l'ensemble des combinaisons maximales de deux biens qu'une économie peut produire en utilisant pleinement ses ressources (travail, capital, terre) avec la technologie disponible. Tout point sur la frontière est efficient, c'est-à-dire qu'il est impossible de produire davantage d'un bien sans réduire la production de l'autre.\n\nLe concept clé illustré par la FPP est le coût d'opportunité : le véritable coût de la production d'un bien n'est pas son prix monétaire mais la quantité de l'autre bien à laquelle on renonce. Si une économie choisit de produire 10 avions de plus, elle doit renoncer, par exemple, à 1 000 voitures. Ce coût d'opportunité est croissant dans le cas général (frontière concave) car les ressources ne sont pas parfaitement substituables : les ouvriers spécialisés dans l'aviation sont moins productifs dans l'automobile, et inversement.\n\nLa FPP permet aussi de comprendre la croissance économique. Quand un pays investit dans l'éducation, la recherche ou les infrastructures, ses capacités productives augmentent et la FPP se déplace vers l'extérieur. Joseph Schumpeter a théorisé ce processus sous le nom de « destruction créatrice » : l'innovation détruit les anciennes méthodes de production mais en crée de plus efficaces, repoussant les limites du possible. Un point situé à l'intérieur de la frontière révèle un gaspillage de ressources (chômage, sous-utilisation des capacités) qui pourrait être corrigé par des politiques appropriées.",
    keyConcepts: [
      { term: "Rareté", definition: "Principe fondamental de l'économie : les ressources (travail, capital, ressources naturelles) sont limitées alors que les besoins et les désirs humains sont illimités. La rareté impose de faire des choix, ce qui est exactement ce que la FPP représente graphiquement." },
      { term: "Coût d'opportunité", definition: "Valeur de la meilleure alternative à laquelle on renonce lorsqu'on fait un choix. Sur la FPP, le coût d'opportunité de la production d'un bien supplémentaire est la quantité de l'autre bien qu'il faut sacrifier. Ce coût est croissant si la frontière est concave (forme classique)." },
      { term: "Efficacité productive", definition: "Situation où l'économie utilise pleinement et au mieux ses ressources. Tout point situé sur la FPP est efficient. Un point à l'intérieur de la frontière indique un gaspillage (chômage, capacités inutilisées). Un point au-delà de la frontière est inaccessible avec les ressources actuelles." },
      { term: "Croissance économique", definition: "Déplacement de la FPP vers l'extérieur, rendu possible par l'accumulation de capital (investissement), le progrès technique (innovation) ou l'augmentation de la force de travail (démographie, immigration). La croissance permet de produire davantage des deux biens simultanément." },
      { term: "Coûts d'opportunité croissants", definition: "Principe selon lequel le coût d'opportunité de la production d'un bien augmente à mesure qu'on en produit davantage. Cela s'explique par le fait que les ressources ne sont pas parfaitement polyvalentes : transférer des ressources spécialisées vers un autre secteur les rend moins productives. C'est ce qui donne à la FPP sa forme concave." },
    ],
    methodology: "Commencez par placer un point de production sur la frontière et notez les quantités des deux biens. Déplacez la production vers le bien A et calculez le coût d'opportunité en termes de bien B. Répétez en sens inverse. Observez que le coût d'opportunité est croissant. Placez ensuite un point à l'intérieur de la frontière : c'est une situation de sous-emploi. Enfin, augmentez les ressources totales ou la productivité pour voir la FPP se déplacer vers l'extérieur.",
    forTeachers: "L'exemple « beurre et canons » est classique mais vous pouvez moderniser avec « smartphones et soins de santé ». Demandez aux élèves de citer des situations réelles de coût d'opportunité dans leur propre vie (étudier vs travailler, par exemple). Le lien avec les avantages comparatifs de Ricardo est un bon pont vers le module suivant.",
  },
};
