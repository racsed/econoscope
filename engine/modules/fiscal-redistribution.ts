...
const meta: ModuleMeta = {
  ...
  course: {
    introduction: "La fiscalité et la redistribution sont au coeur du contrat social. Dans toute économie de marché, la répartition primaire des revenus (celle issue du travail et du capital) produit des inégalités considérables. L'intervention publique, par les prélèvements (impôts, cotisations) et les transferts (allocations, minima sociaux), modifie cette répartition pour la rendre plus conforme à la notion de justice sociale en vigueur dans la société. En France, le système fiscal et social réduit le coefficient de Gini de 0,52 (avant redistribution) à 0,29 (après), soit une réduction de près de 45 % des inégalités.\n\nLe débat sur la progressivité fiscale oppose deux visions. L'impôt progressif, défendu notamment par Thomas Piketty, applique des taux croissants selon le niveau de revenu. Il est fondé sur le principe de capacité contributive : ceux qui gagnent plus peuvent supporter une charge proportionnellement plus lourde sans réduction significative de leur bien-être (utilité marginale décroissante du revenu). L'impôt proportionnel (flat tax), défendu par certains économistes libéraux, applique le même taux à tous et est jugé plus simple, plus transparent et moins distorsif pour l'activité économique.\n\nAu-delà des prélèvements, les transferts sociaux jouent un rôle redistributif au moins aussi important. Le RSA (Revenu de Solidarité Active), la prime d'activité, les allocations familiales et les prestations de logement constituent un filet de sécurité qui bénéficie principalement aux ménages modestes. Le débat contemporain porte sur l'efficacité de ces transferts (taux de non-recours élevé), sur les trappes à inactivité (perte des aides quand on reprend un emploi) et sur des réformes structurelles comme le revenu universel. Le simulateur permet d'explorer ces arbitrages en comparant les effets de différents barèmes fiscaux et niveaux de transferts sur la distribution des revenus.",
    keyConcepts: [
      { term: "Impôt progressif", definition: "Impôt dont le taux effectif augmente avec le revenu. L'impôt sur le revenu français comporte 5 tranches (0 %, 11 %, 30 %, 41 %, 45 %). La progressivité repose sur le principe de capacité contributive et vise à réduire les inégalités après impôt." },
      { term: "Impôt proportionnel (flat tax)", definition: "Impôt qui applique un taux unique à tous les niveaux de revenu. La CSG en France (9,2 % sur les revenus d'activité) et le prélèvement forfaitaire unique sur les revenus du capital (30 %) s'en rapprochent. Il est plus simple mais moins redistributif." },
      { term: "Transferts sociaux", definition: "Prestations versées par l'État ou les organismes sociaux aux ménages : RSA, allocations familiales, aides au logement, prime d'activité. En France, les transferts en espèces représentent environ 30 % du PIB. Ils réduisent la pauvreté et les inégalités mais peuvent créer des effets désincitatifs." },
      { term: "Taux marginal vs taux moyen d'imposition", definition: "Le taux marginal est le taux appliqué au dernier euro gagné. Le taux moyen est le rapport entre l'impôt total payé et le revenu total. Avec un impôt progressif, le taux marginal est toujours supérieur au taux moyen. C'est le taux marginal qui influence les comportements économiques." },
      { term: "Trappe à inactivité", definition: "Situation où un individu n'a pas intérêt financier à reprendre un emploi car la perte des aides sociales compense ou dépasse le gain salarial. Le taux marginal effectif d'imposition (incluant la perte des aides) peut dépasser 80 % pour certains niveaux de revenus, décourageant la reprise d'activité." },
      { term: "Coefficient de Gini avant/après redistribution", definition: "La comparaison du Gini avant redistribution (revenus primaires) et après redistribution (revenus disponibles) mesure l'efficacité du système fiscal et social. Un écart important signifie une forte redistribution. La France, avec un écart de 0,23 point, est l'un des pays qui redistribuent le plus au monde." },
    ],
    methodology: "Commencez par observer la distribution des revenus avant impôt et le coefficient de Gini correspondant. Appliquez un impôt progressif et observez comment la courbe de Lorenz se rapproche de la diagonale. Comparez avec un impôt proportionnel au même rendement fiscal. Ajoutez des transferts sociaux et notez leur effet sur les déciles les plus bas. Essayez de minimiser le Gini : vous constaterez les limites de la redistribution pure (trappe à inactivité, effets sur l'offre de travail).",
    forTeachers: "Le sujet est politiquement sensible mais pédagogiquement très riche. Proposez aux élèves de concevoir leur propre système fiscal (nombre de tranches, taux, transferts) et de comparer les résultats. Le débat « impôt progressif vs flat tax » peut structurer un cours entier. Montrez l'écart France/États-Unis pour illustrer des choix de société différents.",
  },
};
